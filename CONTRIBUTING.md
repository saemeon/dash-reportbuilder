...
Bug reports, feature requests, and pull requests are welcome on [GitHub](https://github.com/saemeon/dash-reportbuilder/issues).

## Development setup

```bash
git clone https://github.com/saemeon/dash-reportbuilder
